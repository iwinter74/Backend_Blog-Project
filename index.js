...
app.get('/', function (req, res) {
    res.status(200).render('index', {blogList: blogList, newBlogList: newBlogList, title: "all_blogs"})
})
  
app.get('/newArticle', function (req, res) {
    res.status(200).render('newArticle', {title: "new_article"})
})
app.get('/blog/:item', (req, res) => {
    console.log(req.params.item)
    console.log(blogList[req.params.item].body.split(" ").length)
    res.status(200).render('singleBlog', { singleBlog: blogList[req.params.item], title: `blog_${blogList[req.params.item].id}`, time: (blogList[req.params.item].body.split(" ").length/60).toFixed(0)
    })
})
